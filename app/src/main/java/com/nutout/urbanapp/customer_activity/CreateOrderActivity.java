package com.nutout.urbanapp.customer_activity;
...
import com.nutout.urbanapp.AuthAbstractActivity;
import com.nutout.urbanapp.R;
import com.nutout.urbanapp.adapters.MenuItemRecyclerAdapter;
import com.nutout.urbanapp.helper.FirebaseKeylist;
import com.nutout.urbanapp.models.MenuItem;
import com.nutout.urbanapp.models.Order;
import com.nutout.urbanapp.models.Restaurant;
        ...
        if (destination != null) {
            ...
            if (user == null){
                ...
                for (MenuItem menuItem : m_Adapter.getMenuItemList()) {
                    theOrder.addItem((MenuItem) menuItem);
                }
